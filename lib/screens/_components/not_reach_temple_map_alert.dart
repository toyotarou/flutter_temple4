...
class NotReachTempleMapAlert extends StatefulWidget {
  ...
  @override
  State<NotReachTempleMapAlert> createState() => _NotReachTempleMapAlertState();
}

class _NotReachTempleMapAlertState extends State<NotReachTempleMapAlert> {
  @override
