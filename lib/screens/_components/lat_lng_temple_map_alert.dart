...
class LatLngTempleMapAlert extends StatefulWidget {
  ...
  @override
  State<LatLngTempleMapAlert> createState() => _LatLngTempleMapAlertState();
}

class _LatLngTempleMapAlertState extends State<LatLngTempleMapAlert> {
  @override
