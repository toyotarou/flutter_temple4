...
class TempleDetailMapAlert extends StatefulWidget {
  ...
  @override
  State<TempleDetailMapAlert> createState() => _TempleDetailMapAlertState();
}

class _TempleDetailMapAlertState extends State<TempleDetailMapAlert> {
  @override
