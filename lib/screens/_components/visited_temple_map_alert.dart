...
class VisitedTempleMapAlert extends StatefulWidget {
  ...
  @override
  State<VisitedTempleMapAlert> createState() => _VisitedTempleMapAlertState();
}

class _VisitedTempleMapAlertState extends State<VisitedTempleMapAlert> {
  @override
